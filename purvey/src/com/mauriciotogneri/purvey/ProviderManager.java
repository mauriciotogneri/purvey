...
{
	private final Map<String, Object> providers = new HashMap<String, Object>();
	private final Map<Method, Object> methodsSingleton = new HashMap<Method, Object>();
	private final Map<Class<?>, Object> returnTypeSingleton = new HashMap<Class<?>, Object>();
	
	private static final Map<Class<?>, Object> rootProviders = new HashMap<Class<?>, Object>();
	...
	public Object invoke(Object proxy, Method method, Object[] parameters) throws Throwable
	{
		synchronized (ProviderManager.class)
		{
			...
			if (provider == null)
			{
				...
				{
					this.providers.put(interf.getName(), newProvider);
				}
			}
			else
			{
